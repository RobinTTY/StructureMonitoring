...
- Copy the generated connection string to the file path of your deployed app:<br> \Sting.Measurements-uwp_gk6cf97c3a7py\LocalState\DeviceConnectionString.txt<br> (you can change this by manipulating the AzureIotHub.cs file)
