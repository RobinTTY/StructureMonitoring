    ...
    receive(maxMessageCount, maxWaitTimeInSeconds) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const finalAction = (timeOver, data) => {
                ...
                if (this._receiver) {
                    this._receiver.removeListener(rhea_promise_1.ReceiverEvents.receiverError, onReceiveError);
                    this._receiver.removeListener(rhea_promise_1.ReceiverEvents.message, onReceiveMessage);
                }
                if (!data) {
            ...
            onReceiveError = (context) => {
                ...
                receiver.removeListener(rhea_promise_1.ReceiverEvents.receiverError, onReceiveError);
                receiver.removeListener(rhea_promise_1.ReceiverEvents.message, onReceiveMessage);
                receiver.session.removeListener(rhea_promise_1.SessionEvents.sessionError, onSessionError);
            ...
            onSessionError = (context) => {
                ...
                receiver.removeListener(rhea_promise_1.ReceiverEvents.receiverError, onReceiveError);
                receiver.removeListener(rhea_promise_1.ReceiverEvents.message, onReceiveMessage);
                receiver.session.removeListener(rhea_promise_1.SessionEvents.sessionError, onReceiveError);
                const sessionError = context.session && context.session.error;
                let error = new amqp_common_1.MessagingError("An error occuured while receiving messages.");
                if (sessionError) {
            ...
            if (!this.isOpen()) {
                ...
                this._receiver.on(rhea_promise_1.ReceiverEvents.message, onReceiveMessage);
                this._receiver.on(rhea_promise_1.ReceiverEvents.receiverError, onReceiveError);
                this._receiver.session.on(rhea_promise_1.SessionEvents.sessionError, onReceiveError);
            }
        });
    }
    /**
