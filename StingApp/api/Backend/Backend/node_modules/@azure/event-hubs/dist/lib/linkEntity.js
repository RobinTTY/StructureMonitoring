...
class LinkEntity {
    ...
    _negotiateClaim(setTokenRenewal) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield amqp_common_1.defaultLock.acquire(this._context.cbsSession.cbsLock, () => { return this._context.cbsSession.init(); });
            ...
            yield amqp_common_1.defaultLock.acquire(this._context.negotiateClaimLock, () => {
