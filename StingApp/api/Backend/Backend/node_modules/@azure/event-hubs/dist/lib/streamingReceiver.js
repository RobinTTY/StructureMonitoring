...
class StreamingReceiver extends eventHubReceiver_1.EventHubReceiver {
    ...
    receive(onMessage, onError) {
        ...
        if (!this.isOpen()) {
            ...
            this._receiver.on(rhea_promise_1.ReceiverEvents.message, this._onAmqpMessage);
            this._receiver.on(rhea_promise_1.ReceiverEvents.receiverError, this._onAmqpError);
