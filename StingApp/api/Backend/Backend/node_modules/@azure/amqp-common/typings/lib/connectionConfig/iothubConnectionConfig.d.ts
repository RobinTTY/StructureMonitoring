...
export declare namespace IotHubConnectionConfig {
     ...
     */
    function convertToEventHubConnectionConfig(iotHubConfig: IotHubConnectionConfig): EventHubConnectionConfig;
}
//# sourceMappingURL=iothubConnectionConfig.d.ts.map