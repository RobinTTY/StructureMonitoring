...
class CbsClient {
    ...
    constructor(connection, connectionLock) {
         ...
         */
        this.replyTo = `${Constants.cbsReplyTo}-${rhea_promise_1.generate_uuid()}`;
        /**
         ...
         */
        this.cbsLock = `${Constants.negotiateCbsKey}-${rhea_promise_1.generate_uuid()}`;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const request = {
                    ...
                    message_id: rhea_promise_1.generate_uuid(),
